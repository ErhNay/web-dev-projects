...
const LOG_EVENT_PLAYER_STRONG_ATTACK = 'STRONG_PLAYER ATTACK';
...
function printLogHandler() {
  ...
  let i = 0;
  for (const [a, logEntry] of battleLog.entries()) {
    for (const entry in logEntry) {
      console.log(`${a} => ${entry} : ${logEntry[entry]}`);
    }
    i++;
  }
}
